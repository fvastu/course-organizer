...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <aside className={cn("flex flex-col w-64 border-r border-primary/30 bg-card h-screen sticky top-0", className)}>
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <div className="mt-8 px-4 py-4 rounded-xl bg-gradient-to-br from-muted to-card text-foreground border border-primary/30 relative overflow-hidden group">
      ...
      <div className="p-4 border-t border-primary/20 text-xs text-center text-muted-foreground">
